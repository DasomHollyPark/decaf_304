...
_lr_productions = [
  ...
  ('empty -> <empty>','empty',0,'p_empty','decafparser.py',18),
  ('class_decl_star -> empty','class_decl_star',1,'p_class_decl_star','decafparser.py',24),
  ('class_decl_star -> class_decl class_decl_star','class_decl_star',2,'p_class_decl_star','decafparser.py',25),
  ('class_decl -> CLASS ID extends_opt LEFT_BRACE class_body_decl_plus RIGHT_BRACE','class_decl',6,'p_class_decl','decafparser.py',31),
  ('extends_opt -> empty','extends_opt',1,'p_extends_opt','decafparser.py',37),
  ('extends_opt -> extends','extends_opt',1,'p_extends_opt','decafparser.py',38),
  ('extends -> EXTENDS ID','extends',2,'p_extends','decafparser.py',44),
  ('class_body_decl_plus -> class_body_decl class_body_decl_plus','class_body_decl_plus',2,'p_class_body_decl_plus','decafparser.py',49),
  ('class_body_decl_plus -> class_body_decl','class_body_decl_plus',1,'p_class_body_decl_plus','decafparser.py',50),
  ('class_body_decl -> field_decl','class_body_decl',1,'p_class_body_decl','decafparser.py',55),
  ('class_body_decl -> method_decl','class_body_decl',1,'p_class_body_decl','decafparser.py',56),
  ('class_body_decl -> constructor_decl','class_body_decl',1,'p_class_body_decl','decafparser.py',57),
  ('field_decl -> modifier var_decl','field_decl',2,'p_field_decl','decafparser.py',66),
  ('modifier -> empty','modifier',1,'p_modifier','decafparser.py',71),
  ('modifier -> PUBLIC','modifier',1,'p_modifier','decafparser.py',72),
  ('modifier -> PRIVATE','modifier',1,'p_modifier','decafparser.py',73),
  ('modifier -> PUBLIC STATIC','modifier',2,'p_modifier','decafparser.py',74),
  ('modifier -> PRIVATE STATIC','modifier',2,'p_modifier','decafparser.py',75),
  ('modifier -> STATIC','modifier',1,'p_modifier','decafparser.py',76),
  ('var_decl -> type variables SEMICOLON','var_decl',3,'p_var_decl','decafparser.py',81),
  ('type -> INT','type',1,'p_type','decafparser.py',86),
  ('type -> FLOAT','type',1,'p_type','decafparser.py',87),
  ('type -> BOOLEAN','type',1,'p_type','decafparser.py',88),
  ('type -> ID','type',1,'p_type','decafparser.py',89),
  ('variables -> variable more_variables','variables',2,'p_variables','decafparser.py',94),
  ('more_variables -> empty','more_variables',1,'p_more_variables','decafparser.py',99),
  ('more_variables -> COMMA variable more_variables','more_variables',3,'p_more_variables','decafparser.py',100),
  ('variable -> ID array_dim_star','variable',2,'p_variable','decafparser.py',105),
  ('array_dim_star -> empty','array_dim_star',1,'p_array_dim_star','decafparser.py',110),
  ('array_dim_star -> array_dim array_dim_star','array_dim_star',2,'p_array_dim_star','decafparser.py',111),
  ('array_dim -> LEFT_BRACKET RIGHT_BRACKET','array_dim',2,'p_array_dim','decafparser.py',116),
  ('method_decl -> modifier type_or_void ID LEFT_PAR formals_opt RIGHT_PAR block','method_decl',7,'p_method_decl','decafparser.py',125),
  ('type_or_void -> type','type_or_void',1,'p_type_or_void','decafparser.py',130),
  ('type_or_void -> VOID','type_or_void',1,'p_type_or_void','decafparser.py',131),
  ('constructor_decl -> modifier ID LEFT_PAR formals_opt RIGHT_PAR block','constructor_decl',6,'p_constructor_decl','decafparser.py',136),
  ('formals_opt -> empty','formals_opt',1,'p_formals_opt','decafparser.py',141),
  ('formals_opt -> formals','formals_opt',1,'p_formals_opt','decafparser.py',142),
  ('formals -> formal_param more_formals','formals',2,'p_formals','decafparser.py',147),
  ('more_formals -> empty','more_formals',1,'p_more_formals','decafparser.py',152),
  ('more_formals -> COMMA formal_param more_formals','more_formals',3,'p_more_formals','decafparser.py',153),
  ('formal_param -> type variable','formal_param',2,'p_formal_param','decafparser.py',158),
  ('block -> LEFT_BRACE stmt_star RIGHT_BRACE','block',3,'p_block','decafparser.py',167),
  ('stmt_star -> empty','stmt_star',1,'p_stmt_star','decafparser.py',172),
  ('stmt_star -> stmt stmt_star','stmt_star',2,'p_stmt_star','decafparser.py',173),
  ('stmt -> IF LEFT_PAR expr RIGHT_PAR stmt else_opt','stmt',6,'p_stmt','decafparser.py',178),
  ('stmt -> WHILE LEFT_PAR expr RIGHT_PAR stmt','stmt',5,'p_stmt','decafparser.py',179),
  ('stmt -> FOR LEFT_PAR stmt_expr_opt SEMICOLON expr_opt SEMICOLON stmt_expr_opt RIGHT_PAR stmt','stmt',9,'p_stmt','decafparser.py',180),
  ('stmt -> RETURN expr_opt SEMICOLON','stmt',3,'p_stmt','decafparser.py',181),
  ('stmt -> stmt_expr SEMICOLON','stmt',2,'p_stmt','decafparser.py',182),
  ('stmt -> BREAK SEMICOLON','stmt',2,'p_stmt','decafparser.py',183),
  ('stmt -> CONTINUE SEMICOLON','stmt',2,'p_stmt','decafparser.py',184),
  ('stmt -> block','stmt',1,'p_stmt','decafparser.py',185),
  ('stmt -> var_decl','stmt',1,'p_stmt','decafparser.py',186),
  ('stmt -> SEMICOLON','stmt',1,'p_stmt','decafparser.py',187),
  ('else_opt -> empty','else_opt',1,'p_else_opt','decafparser.py',192),
  ('else_opt -> ELSE stmt','else_opt',2,'p_else_opt','decafparser.py',193),
  ('literal -> INT_CONST','literal',1,'p_literal','decafparser.py',202),
  ('literal -> FLOAT_CONST','literal',1,'p_literal','decafparser.py',203),
  ('literal -> STRING_CONST','literal',1,'p_literal','decafparser.py',204),
  ('literal -> NULL','literal',1,'p_literal','decafparser.py',205),
  ('literal -> TRUE','literal',1,'p_literal','decafparser.py',206),
  ('literal -> FALSE','literal',1,'p_literal','decafparser.py',207),
  ('primary -> literal','primary',1,'p_primary','decafparser.py',212),
  ('primary -> THIS','primary',1,'p_primary','decafparser.py',213),
  ('primary -> SUPER','primary',1,'p_primary','decafparser.py',214),
  ('primary -> LEFT_PAR expr RIGHT_PAR','primary',3,'p_primary','decafparser.py',215),
  ('primary -> NEW ID LEFT_PAR arguments_opt RIGHT_PAR','primary',5,'p_primary','decafparser.py',216),
  ('primary -> lhs','primary',1,'p_primary','decafparser.py',217),
  ('primary -> method_invocation','primary',1,'p_primary','decafparser.py',218),
  ('arguments_opt -> empty','arguments_opt',1,'p_arguments_opt','decafparser.py',223),
  ('arguments_opt -> arguments','arguments_opt',1,'p_arguments_opt','decafparser.py',224),
  ('arguments -> expr more_expr','arguments',2,'p_arguments','decafparser.py',229),
  ('more_expr -> empty','more_expr',1,'p_more_expr','decafparser.py',234),
  ('more_expr -> COMMA expr more_expr','more_expr',3,'p_more_expr','decafparser.py',235),
  ('lhs -> field_access','lhs',1,'p_lhs','decafparser.py',240),
  ('lhs -> array_access','lhs',1,'p_lhs','decafparser.py',241),
  ('field_access -> primary DOT ID','field_access',3,'p_field_access','decafparser.py',246),
  ('field_access -> ID','field_access',1,'p_field_access','decafparser.py',247),
  ('array_access -> primary LEFT_BRACKET expr RIGHT_BRACKET','array_access',4,'p_array_access','decafparser.py',252),
  ('method_invocation -> field_access LEFT_PAR arguments_opt RIGHT_PAR','method_invocation',4,'p_method_invocation','decafparser.py',257),
  ('expr -> primary','expr',1,'p_expr','decafparser.py',262),
  ('expr -> assign','expr',1,'p_expr','decafparser.py',263),
  ('expr -> new_array','expr',1,'p_expr','decafparser.py',264),
  ('expr -> expr ARITH_OP expr','expr',3,'p_expr','decafparser.py',265),
  ('expr -> expr BOOL_OP expr','expr',3,'p_expr','decafparser.py',266),
  ('expr -> UNARY_OP expr','expr',2,'p_expr','decafparser.py',267),
  ('assign -> lhs EQUALS expr','assign',3,'p_assign','decafparser.py',272),
  ('assign -> lhs PLUS_PLUS','assign',2,'p_assign','decafparser.py',273),
  ('assign -> PLUS_PLUS lhs','assign',2,'p_assign','decafparser.py',274),
  ('assign -> lhs MINUS_MINUS','assign',2,'p_assign','decafparser.py',275),
  ('assign -> MINUS_MINUS lhs','assign',2,'p_assign','decafparser.py',276),
  ('new_array -> NEW type array_expr_plus array_empty_star','new_array',4,'p_new_array','decafparser.py',281),
  ('array_expr_plus -> array_expr array_expr_plus','array_expr_plus',2,'p_array_expr_plus','decafparser.py',286),
  ('array_expr_plus -> array_expr','array_expr_plus',1,'p_array_expr_plus','decafparser.py',287),
  ('array_expr -> LEFT_BRACKET expr RIGHT_BRACKET','array_expr',3,'p_array_expr','decafparser.py',292),
  ('array_empty_star -> empty','array_empty_star',1,'p_array_empty_star','decafparser.py',297),
  ('array_empty_star -> array_empty array_empty_star','array_empty_star',2,'p_array_empty_star','decafparser.py',298),
  ('array_empty -> LEFT_BRACKET RIGHT_BRACKET','array_empty',2,'p_array_empty','decafparser.py',303),
  ('stmt_expr -> assign','stmt_expr',1,'p_stmt_expr','decafparser.py',308),
  ('stmt_expr -> method_invocation','stmt_expr',1,'p_stmt_expr','decafparser.py',309),
  ('stmt_expr_opt -> empty','stmt_expr_opt',1,'p_stmt_expr_opt','decafparser.py',314),
  ('stmt_expr_opt -> stmt_expr','stmt_expr_opt',1,'p_stmt_expr_opt','decafparser.py',315),
  ('expr_opt -> empty','expr_opt',1,'p_expr_opt','decafparser.py',320),
  ('expr_opt -> expr','expr_opt',1,'p_expr_opt','decafparser.py',321),
]
